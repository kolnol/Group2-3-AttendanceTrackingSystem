...
<%-- //[START imports]--%>
<%@ page import="de.tum.atse.ats.Entity.Greeting" %>
<%@ page import="de.tum.atse.ats.Guestbook" %>
...
<%
      // Look at all of our greetings
        for (Greeting greeting : greetings) {
            pageContext.setAttribute("greeting_content", "Your site is awesome:" + greeting.content);
            String author;
